...
def reset_all_progress():
    ...
    try:
        ...
        # Clear all user achievements (where user_id is not NULL)
        cursor.execute('DELETE FROM achievements WHERE user_id IS NOT NULL')
        ...
        print("   • All user achievements reset")
        print("   • All user stats reset to zero")
        print("   • User accounts remain intact")
        print("   • Predefined achievements remain intact")
...
if __name__ == '__main__':
    ...
    print("   • All user achievements will be reset")
    print("   • All points and streaks will be reset to zero")
    print("   • User accounts will remain intact")
    print("   • Predefined achievements will remain intact")
    print()
